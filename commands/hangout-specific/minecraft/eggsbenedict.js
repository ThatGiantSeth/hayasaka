module.exports = {
	...
	callback: async ({ message, args }) => {
		...
		if (infoOption.toLowerCase() === 'instructions') {
			...
			.setColor('#000000')
			.setDescription('Custom Installer and Launcher instructions:\nhttps://docs.google.com/document/d/1cWx4sZMcx3pCfcpXpGDJ5GwwZyoQ6UUtkxHXPKX4y7A/edit?usp=sharing \n\nIf you\'d like to install the mods manually:\nhttps://docs.google.com/document/d/1-aPMETJhhBA8rqcj-e2hWzBcdIx8yaZ62QkvkXxtZ4s/edit')
			.setFooter('Hayasaka', 'https://i.imgur.com/W1lcK9M.gif');
            message.channel.send(embed);
		}
	}
